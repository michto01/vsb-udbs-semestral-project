...
s properties.' , 'TABLE' , 'UserIntentory' , 'COLUMN' , 'i_type
' 
GO



EXEC sp_addextendedproperty 'MS_Description' , 'JSON string describing
properties OF the object;
because we have really strange objects we keep it IN JSON
WITH
  the original parser
FROM
  OLD engine OF JM.' , 'TABLE' , 'UserIntentory' , 'COLUMN' , 'i_content' 
GO
